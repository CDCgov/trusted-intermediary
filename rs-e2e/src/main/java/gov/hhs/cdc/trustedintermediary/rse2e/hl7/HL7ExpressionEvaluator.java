...
/**
 * The HL7ExpressionEvaluator class is responsible for evaluating expressions on HL7 messages. The
 * expressions can be used to compare fields, count segments, and check for membership. The
