...
class ValidationRuleEngineIntegrationTest extends Specification {
    ...
    def "validation passes: Message has required receiver id"() {
        ...
        def bundle = HapiTestHelper.createMessageBundle(receiverOrganization: receiverOrganization)
        ...
        receiverOrganization
                ...
                .setValue("simulated-hospital-id")
        bundle = HapiTestHelper.createMessageBundle(receiverOrganization: receiverOrganization)
