...
class PartnerMetadataOrchestratorTest extends Specification {
    ...
    def "getMetadata gets receiver if missing from metadata"() {
        ...
        def missingReceiverMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, timeDelivered, hashCode, PartnerMetadataStatus.DELIVERED, "", messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
        def expectedMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, timeDelivered, hashCode, PartnerMetadataStatus.DELIVERED, "", messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
    ...
    def "getMetadata gets status if still pending in metadata"() {
        given:
        def rsHistoryApiResponse = "{\"destinations\": [{\"organization_id\": \"org\", \"service\": \"service\"}]}"
        def missingReceiverMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, null, hashCode, PartnerMetadataStatus.PENDING, null, messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
        def expectedMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, null, hashCode, PartnerMetadataStatus.FAILED, "", messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
    ...
    def "getMetadata doesn't update the error messages if the status isn't FAILED when calling the RS history API"() {
        ...
        def messageType = PartnerMetadataMessageType.RESULT
        def missingReceiverMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, timeDelivered, hashCode, PartnerMetadataStatus.PENDING, null, messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
        def expectedMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, timeDelivered, hashCode, PartnerMetadataStatus.DELIVERED, null, messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
    ...
    def "getMetadata saves loaded delivered metadata if found"() {
        ...
        def messageType = PartnerMetadataMessageType.RESULT
        def missingReceiverMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, null, hashCode, PartnerMetadataStatus.PENDING, null, messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
        def expectedMetadata = new PartnerMetadata(receivedSubmissionId, sentSubmissionId, timestamp, null, hashCode, PartnerMetadataStatus.DELIVERED, null, messageType, sendingApp, sendingFacility, receivingApp, receivingFacility, placerOrderNumber)
