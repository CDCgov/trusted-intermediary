...
class FilePartnerMetadataStorageTest extends Specification {
    ...
    def "saveMetadata throws PartnerMetadataException when unable to save file"() {
        ...
        def receivingApp = new MessageHdDataType("receiving_app_name", "receiving_app_id", "receiving_app_type")
        def receivingFacility = new MessageHdDataType("receiving_facility_name", "receiving_facility_id", "receiving_facility_type")
        PartnerMetadata metadata = new PartnerMetadata("receivedSubmissionId", "sentSubmissionId","sender", "receiver", Instant.now(), Instant.now(), "abcd", PartnerMetadataStatus.DELIVERED, null, PartnerMetadataMessageType.ORDER, sendingApp, sendingFacility, receivingApp, receivingFacility, "placer_order_number")
    ...
    def "readMetadata throws PartnerMetadataException when unable to parse file"() {
        ...
        def receivingApp = new MessageHdDataType("receiving_app_name", "receiving_app_id", "receiving_app_type")
        def receivingFacility = new MessageHdDataType("receiving_facility_name", "receiving_facility_id", "receiving_facility_type")
        PartnerMetadata metadata = new PartnerMetadata(submissionId, null, null, null, null, null, null, null, null, null, sendingApp, sendingFacility, receivingApp, receivingFacility, "placer_order_number")
        FilePartnerMetadataStorage.getInstance().saveMetadata(metadata)
    ...
    def "readMetadataForSender returns a set of PartnerMetadata"() {
        ...
        def receivingApp = new MessageHdDataType("receiving_app_name", "receiving_app_id", "receiving_app_type")
        def receivingFacility = new MessageHdDataType("receiving_facility_name", "receiving_facility_id", "receiving_facility_type")
        PartnerMetadata metadata2 = new PartnerMetadata("abcdefghi", null, sender, null, null, null, null, null, null, null, sendingApp, sendingFacility, receivingApp, receivingFacility, "placer_order_number")
        PartnerMetadata metadata1 = new PartnerMetadata("123456789", null, sender, null, null, null, null, null, null, null, sendingApp, sendingFacility, receivingApp, receivingFacility, "placer_order_number")
