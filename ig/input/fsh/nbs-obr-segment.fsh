...
* setOBRId 1..1 positiveInt "OBR-1 Set ID"
* placerOrderNumber 1..1 string "OBR-2 Placer Order Number"
* placerOrderNumberEntityIdentifier 1..1 string "OBR-2.1 Placer Order Number Entity Identifier"
* placerOrderNumberNamespaceID 1..1 string "OBR-2.2 Placer Order Number Namespace ID"
* placerOrderNumberUniversalID 1..1 string "OBR-2.3 Placer Order Number Universal ID"
* placerOrderNumberUniversalIDType 1..1 code "OBR-2.4 Placer Order Number Universal ID Type"
* universalServiceIdentifier 1..1 string "OBR-4 Universal Service Identifier"
* universalServiceIdentifierIdentifier 1..1 string "OBR-4.1 Universal Service Identifier Identifier"
* universalServiceIdentifierText 1..1 string "OBR-4.2 Universal Service Identifier Text"
* universalServiceIdentifierNameOfCodingSystem 1..1 string "OBR-4.3 Universal Service Identifier Name Of Coding System"
* universalServiceIdentifierOriginalText 1..1 string "OBR-4.9 Universal Service Identifier Original Text"
* observationDateTime 1..1 dateTime "OBR-7 Observation Date/Time"
* specimenActionCode 1..1 string "OBR-11 Specimen Action Code (value is always 'P')"
