...
* orderControl 1..1 SU code "ORC-1 Order Control"
* placerOrderNumber 1..1 SU string "ORC-2 Placer Order Number"
* placerOrderNumberEntityIdentifier 1..1 SU string "ORC-2.1 Placer Order Number Entity Identifier"
* placerOrderNumberNamespaceID 1..1 SU string "ORC-2.2 Placer Order Number Namespace ID"
* placerOrderNumberUniversalID 1..1 SU string "ORC-2.3 Placer Order Number Universal ID"
* placerOrderNumberUniversalIDType 1..1 SU code "ORC-2.4 Placer Order Number Universal ID Type"
* orderStatus 0..1 SU string "ORC-5 Order Status"
...
* orderingFacilityNameTypeCode 0..1 SU code "ORC-21.2 Ordering Facility Type Code"
* orderingFacilityNameAssigningAuthority 1..1 SU string "ORC-21.6 Ordering Facility Assigning Authority"
