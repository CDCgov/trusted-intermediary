...
* receivingFacilityNamespaceId 1..1 SU string "MSH-6.1 Namespace ID"
* receivingFacilityUniversalId 1..1 SU string "MSH-6.2 Universal ID"
* receivingFacilityUniversalIdType 1..1 SU string "MSH-6.3 Universal ID Type"
