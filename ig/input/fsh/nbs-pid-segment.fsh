...
* patientIdentifierListTypeCode 1..1 SU string "PID-3.5 Patient identifier Type Code"
...
* patientNameTypeCode 1..1 SU string "PID-5.7 Patient Name Type Code"
...
* patientAddressStreet 0..1 SU string "PID-11.1 Patient Street Address"
* patientAddressStreetMailing 0..1 SU string "PID-11.1.1 Patient Street or Mailing Address"
* patientAddressCity 0..1 SU string "PID-11.3 Patient Address City"
* patientAddressPostalCode 0..1 SU string "PID-11.5 Patient Address ZIP or Postal Code"
* patientAddressCountry 0..1 SU string "PID-11.6 Patient Address Country"
* patientAddressType 0..1 SU string "PID-11.7 Patient Address Type"
...
* phoneNumberHomeType 0..1 SU string "PID-13.3 Phone Number Telecommunication Equipment Type"
